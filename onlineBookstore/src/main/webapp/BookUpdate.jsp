...
<style>
  .products-table{
         width: 300px; height: 320px; background-color: silver; border: 5px solid black; 
         }
  .buy{
      width: 50px; height: 21px; background-color: limegreen; border: 2px solid black}
	...
	<div id="center">
			...
			<form action="product" method="POST" enctype="multipart/form-data">
			 ...
			 <input type="hidden" name="Adminid" value="${Adminid }"> 
				...
				<c:choose>
					<c:when test="${param[\"addProduct\"] != null}">
						 <input class="buy" type="submit" value="Add">
					</c:when>
					<c:otherwise>
