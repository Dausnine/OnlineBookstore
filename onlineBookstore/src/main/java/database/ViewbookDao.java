...
public class ViewbookDao {
	...
	public static List<ViewbookBean> getAll() {
		...
		String sql = "SELECT * FROM book1 p JOIN admin s ON (p.Adminid = s.Adminid) ORDER BY id;";
	...
	public static void addOne(ViewbookBean product) {
		...
		// Prepared statement
		String sql = "INSERT INTO book1 (bookname, bookpublish, bookcategory, bookdescription, bookprice, quantity, image, Adminid ) "
				+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
